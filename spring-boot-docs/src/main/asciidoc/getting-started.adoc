...
ifeval::["{spring-boot-repo}" != "release"]
		...
		<repositories>
			<repository>
				...
				<url>http://10.176.0.11:8081/artifactory/remote-spring</url>
...
----
	buildscript {
		repositories {
			jcenter()
ifndef::release[]
			maven { url "http://10.176.0.11:8081/artifactory/remote-spring" }
...
Cutting edge http://10.176.0.11:8081/artifactory/remote-spring/org/springframework/boot/spring-boot-cli/[snapshot distributions]
are also available.
