...
ifeval::["{spring-boot-repo}" != "release"]
		...
		<repositories>
			<repository>
				...
				<url>http://10.176.0.11:8081//snapshot</url>
				<snapshots><enabled>true</enabled></snapshots>
			</repository>
			<repository>
				<id>spring-milestones</id>
				<url>http://10.176.0.11:8081//milestone</url>
			</repository>
		</repositories>
		<pluginRepositories>
			<pluginRepository>
...
----
	buildscript {
		repositories {
			jcenter()
ifndef::release[]
			maven { url "http://10.176.0.11:8081//snapshot" }
			maven { url "http://10.176.0.11:8081//milestone" }
endif::release[]
		}
		dependencies {
...
* http://10.176.0.11:8081//{spring-boot-repo}/org/springframework/boot/spring-boot-cli/{spring-boot-version}/spring-boot-cli-{spring-boot-version}-bin.zip[spring-boot-cli-{spring-boot-version}-bin.zip]
* http://10.176.0.11:8081//{spring-boot-repo}/org/springframework/boot/spring-boot-cli/{spring-boot-version}/spring-boot-cli-{spring-boot-version}-bin.tar.gz[spring-boot-cli-{spring-boot-version}-bin.tar.gz]

Cutting edge http://10.176.0.11:8081//snapshot/org/springframework/boot/spring-boot-cli/[snapshot distributions]
are also available.
